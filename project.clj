(defproject tammymakesthings/machinecfg "0.1.0-SNAPSHOT"
  ...
  :dependencies [ 
                 ...
                 [spootnik/unilog "0.7.32" :exclusions [
  ...
  :dev-dependencies [
                     ...
                     [lambdaisland/kaocha "1.88.1376" :exclusions [
  ...
  :aliases {
            "test" ["run" "-m" "kaocha.runner" "--focus" ":unit"]
